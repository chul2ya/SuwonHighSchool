...
RECT WINAPI DXUTGetWindowClientRectAtModeChange()          { RECT rc = { 0, 0, (LONG)GetDXUTState().GetWindowBackBufferWidthAtModeChange(), (LONG)GetDXUTState().GetWindowBackBufferHeightAtModeChange() }; return rc; }
RECT WINAPI DXUTGetFullsceenClientRectAtModeChange()       { RECT rc = { 0, 0, (LONG)GetDXUTState().GetFullScreenBackBufferWidthAtModeChange(), (LONG)GetDXUTState().GetFullScreenBackBufferHeightAtModeChange() }; return rc; }
